...
@benchmark( 
   { 
       ...
       "log.final.system.TotAngMom": {"value": 4.450092e+35, "unit": (u.kg * u.m ** 2) / u.sec, "rtol": 2e-4}, 
       "log.final.system.TotEnergy": {"value": -8.591537e+30, "unit": u.Joule, "rtol": 2e-4}, 
       "log.final.system.PotEnergy": {"value": -2.477253e+31, "unit": u.Joule, "rtol": 2e-4}, 
       "log.final.system.KinEnergy": {"value": 1.618099e+31, "unit": u.Joule, "rtol": 2e-4}, 
       "log.final.system.DeltaTime": {"value": 6.275124e+09, "unit": u.sec}, 
       "log.final.planet.Mass": {"value": 1.140116, "unit": u.Mearth}, 
       "log.final.planet.Radius": {"value": 7.494630e+07, "unit": u.m, "rtol": 2e-4}, 
       "log.final.planet.RadGyra": {"value": 0.400000}, 
       "log.final.planet.BodyType": {"value": 0.000000}, 
       "log.final.planet.Density": {"value": 3.861386, "unit": u.kg / u.m ** 3, "rtol": 2e-4}, 
       ...
       "log.final.planet.PlanetRadius": {"value": 11.750569, "unit": u.Rearth, "rtol": 2e-4}, 
       ...
       "log.final.planet.DEnvMassDt": {"value": -2.910047e+10, "unit": u.kg / u.sec, "rtol": 2e-4}, 
       ...
       "log.final.planet.RRCriticalFlux": {"value": 0.096815, "unit": u.W / u.m ** 2, "rtol": 2e-4}, 
       ...
       "log.final.planet.HREFFLUX": {"value": 7.448616e+20, "unit": 1 / u.m ** 2 / u.sec, "rtol": 2e-4}, 
       "log.final.planet.XO2": {"value": 0.000000}, 
       "log.final.planet.XH2O": {"value": 0.000000}, 
       "log.final.planet.HDiffFlux": {"value": 1.566642e+15, "unit": 1 / u.m ** 2 / u.sec, "rtol": 2e-4}, 
